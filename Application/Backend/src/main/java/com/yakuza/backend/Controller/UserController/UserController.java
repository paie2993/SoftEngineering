...
import com.yakuza.backend.Controller.UserController.Model.UpdateUserRequestModel;
...
public class UserController {
    ...
    @PostMapping("/login")
    public ResponseEntity<LoginResponseModel> loginUser(@RequestBody LoginRequestModel request) throws Exception {
        ...
        return ResponseEntity.ok(new LoginResponseModel(jwtToken, request.getUsername(), role, id));
    }
    ...
    public ResponseEntity<?> getUserDetails(@ApiIgnore Principal principal, @RequestParam Integer id) {
        ...
        // if the requesting user doesn't correspond with the user who's information is requested, respond with error
    ...
    @PutMapping("/")
    public ResponseEntity<?> updateUserDetails(@ApiIgnore Principal principal, @RequestBody UpdateUserRequestModel request) {
